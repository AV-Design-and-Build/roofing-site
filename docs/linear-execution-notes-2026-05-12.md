...
- Google accepted the save and now shows the social-profile edit under `PENDING`; this does not update Facebook itself, but it should stop GBP from promoting the stale Facebook citation after Google publishes the pending edit.
