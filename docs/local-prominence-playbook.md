...
- Google saved the change as a pending edit. This reduces Google-controlled promotion of the stale Facebook citation, but the actual Facebook page still requires owner/Page access or owner action to normalize its public NAP.
